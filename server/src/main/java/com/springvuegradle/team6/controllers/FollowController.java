...
public class FollowController {
  ...
  public ResponseEntity<String> followActivity(
  ...
  public ResponseEntity<String> getFollowingActivity(
      @PathVariable int profileId, @PathVariable int activityId, HttpSession session) {
    Profile profile = profileRepository.findById(profileId);
    if (profile == null) {
      return new ResponseEntity("No such user", HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<String> unfollowActivity(
      @PathVariable int profileId, @PathVariable int activityId, HttpSession session) {
    // Check Authorisation
    ResponseEntity<String> authorisedResponse =
        UserSecurityService.checkAuthorised(profileId, session, profileRepository);
  ...
  public ResponseEntity editSubscription(
    ...
    if (activityRoleFound == null) {
      ...
      if (optionalSubscription.isEmpty()) {
        ...
        subscriptionHistoryRepository.save(subscriptionHistory);
        return new ResponseEntity(
            "Activity role created and user is now subscribed", HttpStatus.OK);
      } else {
