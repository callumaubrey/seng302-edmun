            ...
            <b-card style="margin: 1em " title="About:">
              ...
              <div v-else>
                ...
                <b-row v-if="location != null">
                  <b-col cols="3"><b>Location:</b></b-col>
                  <b-col
                    ><p>{{ locationString }}</p></b-col
                  >
                </b-row>
                <b-row>
                  <b-col cols="3"><b>Description:</b></b-col>
                  <b-col
                    ><p>{{ description }}</p></b-col
                  >
                </b-row>
                <b-row>
            ...
            <b-card style="margin: 1em" title="Participants:">
              ...
              <div v-else>
                <b-row>
                  ...
                  <b-col>
                    <p v-if="activityOwner">
                      {{ activityOwner.firstname }} {{ activityOwner.lastname }}
                    </p>
                  </b-col>
                </b-row>
                <b-row>
                  ...
                  <b-col
                    ><p>
                      List of other participants possibly with links to profiles
                    </p></b-col
                  >
                </b-row>
              </div>
...
const App = {
  ...
  methods: {
    getUserName: function() {
      ...
      axios
        .get("http://localhost:9499/profiles/firstname")
        .then(res => {
    ...
    getLoggedInId: function() {
      ...
      axios.defaults.withCredentials = true;
      axios
        .get("http://localhost:9499/profiles/id")
        .then(res => {
    ...
    getActivityData() {
      ...
      axios.defaults.withCredentials = true;
      axios
        .get("http://localhost:9499/activities/" + activityId)
        .then(res => {
