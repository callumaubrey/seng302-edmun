            ...
            <b-row align-v="center" class="text-center">
              ...
              <b-col v-if="activityCreatorId==loggedInId" class="text-right">
                <b-dropdown id="dropdown-1" class="m-md-2" text="Organiser">
                  <b-dropdown-item @click="changeRole(user, 'participant')">Make Participant</b-dropdown-item>
            ...
            <b-row class="text-center" align-v="center">
              ...
              <b-col v-if="activityCreatorId==loggedInId" class="text-right">
                <b-dropdown id="dropdown-1" class="m-md-2" text="Participant">
                  <b-dropdown-item @click="changeRole(user, 'organiser')">Make Organiser</b-dropdown-item>
                  <b-dropdown-item @click="removeRole(user)">Remove</b-dropdown-item>
                </b-dropdown>
              </b-col>
            </b-row>
        ...
        <b-tab key="Followers" @click="currentGroup='Followers'">
          ...
          <b-card style="margin-top:10px;" :key="user.profile_id"
            ...
            <b-row align-v="center" class="text-center">
              ...
              <b-col v-if="activityCreatorId==loggedInId" class="text-right">
                <b-dropdown id="dropdown-1" class="m-md-2" text="Follower">
                  <b-dropdown-item @click="removeRole(user)">Remove</b-dropdown-item>
                </b-dropdown>
              </b-col>
            </b-row>
        ...
        <b-tab key="Accessors" @click="currentGroup='Accessors'">
          ...
          <b-card style="margin-top:10px;" :key="user.profile_id" v-for="user in accessors">
            <b-row align-v="center" class="text-center">
              ...
              <b-col v-if="activityCreatorId==loggedInId" class="text-right">
                <b-dropdown id="dropdown-1" class="m-md-2" text="Accessor">
                  <b-dropdown-item @click="removeRole(user)">Remove</b-dropdown-item>
                </b-dropdown>
              </b-col>
            </b-row>
